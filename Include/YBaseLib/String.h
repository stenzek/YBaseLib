...
public:
  ...
  // accessor operators
  // const char &operator[](uint32 i) const { DebugAssert(i < m_pStringData->StringLength); return
  // m_pStringData->pBuffer[i]; }  char &operator[](uint32 i) { DebugAssert(i < m_pStringData->StringLength); return
