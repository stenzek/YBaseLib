...
public:
    ...
    {
    private:
        Connection(HANDLE hTargetProcess, HANDLE hQuitEvent, HANDLE hReadPipe, HANDLE hWritePipe, bool isParentConnection, bool terminateOnParentLost);
...
public:
    ...
    static Subprocess *Create(const char *executableFileName, const char *parameters = NULL, bool openChannel = true, bool newConsole = true, bool terminateOnParentLost = true);
