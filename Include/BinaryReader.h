...
public:
    ...
    inline BinaryReader &operator>>(int8 &dest) { dest = ReadInt8(); return *this; }
    inline BinaryReader &operator>>(uint8 &dest) { dest = ReadUInt8(); return *this; }
    inline BinaryReader &operator>>(int16 &dest) { dest = ReadInt16(); return *this; }
    inline BinaryReader &operator>>(uint16 &dest) { dest = ReadUInt16(); return *this; }
    inline BinaryReader &operator>>(int32 &dest) { dest = ReadInt32(); return *this; }
    inline BinaryReader &operator>>(uint32 &dest) { dest = ReadUInt32(); return *this; }
    inline BinaryReader &operator>>(int64 &dest) { dest = ReadInt64(); return *this; }
    inline BinaryReader &operator>>(uint64 &dest) { dest = ReadUInt64(); return *this; }
    inline BinaryReader &operator>>(float &dest) { dest = ReadFloat(); return *this; }
    inline BinaryReader &operator>>(double &dest) { dest = ReadDouble(); return *this; }
    inline BinaryReader &operator>>(String &dest) { ReadCString(dest); return *this; }
